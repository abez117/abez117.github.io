function checkEmail()
{
    ...
    if(email == "") //conditional expression, when it is ftru, the code in the blick will be executed
    {
    ...
    if(confirm == "") //conditional expression, when it is ftru, the code in the blick will be executed
    {
    ...
    //check both texboxes have the same value
